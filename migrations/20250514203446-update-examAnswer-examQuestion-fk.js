...
module.exports = {
  async up(queryInterface, Sequelize) {
    ...
    try {
      await queryInterface.removeConstraint("exam_answers", "exam_answers_questions_id_fkey");
    } catch (error) {
    ...
    await queryInterface.addConstraint("exam_answers", {
      fields: ["questions_id"],
      type: "foreign key",
      name: "exam_answers_questions_id_fkey",
      references: {
