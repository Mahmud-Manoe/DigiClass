...
module.exports = {
  async up(queryInterface, Sequelize) {
    ...
    try {
      await queryInterface.removeConstraint("announcement", "announcement_class_id_fkey");
    } catch (error) {
    ...
    await queryInterface.addConstraint("announcement", {
      fields: ["class_id"],
      type: "foreign key",
      name: "announcement_class_id_fkey",
      references: {
        table: "classes",
        field: "class_id",
      },
